...
namespace Guardrails
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Guardrails.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Guardrails.IAutoSDKHook>();
        ...
        /// </summary>
        public global::Guardrails.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Guardrails.AutoSDKClientOptions UseAuthorizationProvider(
            global::Guardrails.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Guardrails.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Guardrails.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Guardrails.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Guardrails.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Guardrails.AutoSDKAuthorizationValue>?> ResolveAsync(
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Guardrails.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Guardrails.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Guardrails.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Guardrails.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Guardrails.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    internal static class AutoSDKRequestOptionsSupport
    {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Guardrails.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Guardrails.IAutoSDKHook, global::Guardrails.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Guardrails.AutoSDKHookContext context)
        {
